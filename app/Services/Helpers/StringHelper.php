...
class StringHelper
{
    ...
    public static function findLongestCommonSubstringInArray(array $strings): string
    {
        ...
        for ($i = 1; $i < $numStrings; $i++) {
            $lcs = self::findLongestCommonSubstring($lcs, $strings[$i]);
            if ($lcs == '') {
                break;
            }
        }
    ...
    /**
     * This function uses dynamic programming algorithm to find the longest common substring
