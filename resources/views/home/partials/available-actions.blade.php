@if(count(data_get($transactionsData, 'transactions')) === 0)
    <div class="mb-4">
        <a href="{{ route('institution.index') }}">
            <div
                class="rounded-md transition shadow text-white flex items-center pr-6 p-2 cursor-pointer hover:scale-[1.01] active:scale-[0.99] bg-gradient-to-r from-indigo-700 via-indigo-500 to-indigo-400">
