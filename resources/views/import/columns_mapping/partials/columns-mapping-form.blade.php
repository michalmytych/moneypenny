    ...
    <form action="{{ route('import.columns-mapping.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="transaction_date_column_index" id="transaction_date_column_index"
                   ...
                   value="{{ old('transaction_date_column_index', $columnsMapping->transaction_date_column_index ?? '') }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="accounting_date_column_index" id="accounting_date_column_index"
                   ...
                   value="{{ old('accounting_date_column_index', $columnsMapping->accounting_date_column_index ?? '') }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="sender_column_index" id="sender_column_index"
                   ...
                   value="{{ old('sender_column_index', $columnsMapping->sender_column_index ?? '') }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="receiver_column_index" id="receiver_column_index"
                   ...
                   value="{{ old('receiver_column_index', $columnsMapping->receiver_column_index ?? '') }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="description_column_index" id="description_column_index"
                   ...
                   value="{{ old('description_column_index', $columnsMapping->description_column_index ?? '') }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="currency_column_index" id="currency_column_index"
                   ...
                   value="{{ old('currency_column_index', $columnsMapping->currency_column_index ?? '') }}" required>
