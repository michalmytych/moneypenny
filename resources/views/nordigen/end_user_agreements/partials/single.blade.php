<div class="bg-white rounded-lg shadow-md overflow-hidden mb-4 p-2">
    <div class="flex justify-between">
        <div class="flex">
            <img src="{{ $institution->logo }}" alt="{{ $institution->name }} logo" style="width: 100px; height: 100px;" class="ml-2 mt-2 mb-2 rounded-md">
            <ul class="ml-4">
        ...
        <div class="h-20 w-20 flex justify-center pt-3 pl-3">
            <div>
                <form action="{{ route('institution.delete_agreement', ['agreementId' => $agreement->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
